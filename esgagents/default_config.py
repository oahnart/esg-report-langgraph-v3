...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "evidence_curator_concurrency": 4,
    "evidence_curator_timeout_seconds": 120,
    "evidence_curator_incremental": True,
    "sentence_grounding_enforced": True,
...
_ENV_OVERRIDES = {
    ...
    "ESG_EVIDENCE_CURATOR_CONCURRENCY": "evidence_curator_concurrency",
    "ESG_EVIDENCE_CURATOR_TIMEOUT_SECONDS": "evidence_curator_timeout_seconds",
    "ESG_EVIDENCE_CURATOR_INCREMENTAL": "evidence_curator_incremental",
    "ESG_SENTENCE_GROUNDING_ENFORCED": "sentence_grounding_enforced",
