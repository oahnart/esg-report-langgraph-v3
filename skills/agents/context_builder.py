                ...
                "user_prompt": "\n".join(
                    [
                        ...
                        *(f"- {line}" for line in evidence_lines),
                        ...
                        "Coverage policy: For metric_status=found_table, write Final Answer only from narrative_evidence; metric_evidence is reserved for the separate Qualitative Table Metrics worksheet, and formulas, boundary changes, accounting-method changes, and comparability caveats from narrative_evidence must be preserved. For metric_status=not_found, write qualitative content only from non-metric items[]; ignore narrative_evidence and normalized_answer_ko, leave numeric cells empty, and never infer a figure from prose.",
